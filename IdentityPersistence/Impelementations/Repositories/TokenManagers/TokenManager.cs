using IdentityApplication.Contracts.Repositories.TokenManagers;
...
using IdentityApplication.Contracts.Repositories.RefreshToken;
using IdentityApplication.Contracts.UnitOfWork;
namespace IdentityPersistence.Impelementations.Repositories.TokenManagers
{
    public class TokenManager : ITokenManager
    {
        ...
        public TokenManager(IConfiguration configuration, IRefreshToken refreshToken, IUnitOfWork unitOfWork)
        {
